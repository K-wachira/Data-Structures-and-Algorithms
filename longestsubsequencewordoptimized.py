...
"""
on this approach we will create a dictionary with key as letter and value as list of the index of each letter
"""
import collections
...
find_longest_word_in_string(letters, words)
